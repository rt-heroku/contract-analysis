...
import { TryCatchFinallyAction } from './actions/TryCatchFinallyAction';
import { RaiseErrorAction } from './actions/RaiseErrorAction';
import { OnErrorAction } from './actions/OnErrorAction';
import { CallProcessAction } from './actions/CallProcessAction';
...
export class ActionExecutor {
  ...
  private registerBuiltInActions() {
    ...
    this.actionHandlers.set('try_catch_finally', new TryCatchFinallyAction());
    this.actionHandlers.set('raise_error', new RaiseErrorAction());
    this.actionHandlers.set('on_error', new OnErrorAction());
    this.actionHandlers.set('call_process', new CallProcessAction());
