...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-gray-200 text-gray-700 hover:bg-gray-300 focus:ring-gray-500 disabled:bg-gray-100 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 dark:disabled:bg-gray-800',
    ...
    outline: 'border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-500 disabled:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 dark:disabled:bg-gray-800',
  };
