...
export const Textarea: React.FC<TextareaProps> & { craft?: any } = ({
  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={rows}
        maxLength={maxLength}
        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-vertical"
      />
      {maxLength && (
...
const TextareaSettings: React.FC = () => {
  const {
    actions: { setProp },
    label,
    placeholder,
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-2">
          ...
          <div>
            <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Rows: {rows}</label>
            <input
              type="range"
              min="2"
              max="20"
          ...
          <div>
            ...
            <input
              type="number"
              value={maxLength}
              onChange={(e) => setProp((props: any) => (props.maxLength = parseInt(e.target.value)))}
              className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded"
            />
          </div>
